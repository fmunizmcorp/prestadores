...
// DIAGNOSTIC ROUTE - Sprint 16 (before switch to bypass caching)
if ($route === '__diagnostic' || $route === '_diagnostic' || isset($_GET['diagnostic'])) {
    header('Content-Type: text/plain; charset=utf-8');
    if (file_exists(ROOT_PATH . '/diagnostic_complete_v7.php')) {
        require ROOT_PATH . '/diagnostic_complete_v7.php';
    } else {
        echo "Diagnostic file not found at: " . ROOT_PATH . '/diagnostic_complete_v7.php';
    }
    exit;
}
...
try {
    switch ($route) {
        ...
        // Projetos - RE-ENABLED (Sprint 15.10)
        case 'projetos':
        case 'proj':
        case 'projects':
            try {
        ...
        // Atividades - RE-ENABLED (Sprint 15.10)
        case 'atividades':
        case 'ativ':
        case 'tasks':
            try {
        ...
        // Financeiro - RE-ENABLED (Sprint 15.10)
        case 'financeiro':
        case 'finance':
        case 'fin':
            try {
        ...
        // Notas Fiscais - RE-ENABLED (Sprint 15.10)
        case 'notas-fiscais':
        case 'nf':
        case 'invoices':
            try {
