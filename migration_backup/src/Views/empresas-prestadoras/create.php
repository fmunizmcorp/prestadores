<?php
$pageTitle = 'Nova Empresa Prestadora';
...
<div class="row mb-4">
    <div class="col-md-12">
        <h2><i class="fas fa-plus-circle"></i> Nova Empresa Prestadora</h2>
        <p class="text-muted">Cadastrar nova empresa cliente (prestadora de serviço)</p>
    </div>
</div>

<form method="POST" action="?page=empresas-prestadoras&action=store" enctype="multipart/form-data" class="needs-validation" novalidate>
