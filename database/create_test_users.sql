...
-- Sprint 67 - Correção ENUM roles (compatibilidade)
-- Data: 2025-11-16
--
-- IMPORTANTE: Executar migration 026_fix_usuarios_role_enum.sql ANTES deste script
-- para garantir que todos os valores de role estejam disponíveis no ENUM
