...
// Define paths - File is in /public_html/, application files are also in /public_html/
...
if (!is_dir(SRC_PATH)) {
    echo "❌ ERROR: SRC_PATH does not exist: " . SRC_PATH . "\n";
...
if (!file_exists(CONFIG_PATH . '/database.php')) {
    echo "❌ ERROR: database.php not found at: " . CONFIG_PATH . "/database.php\n";
    exit(1);
}
...
if (!file_exists(SRC_PATH . '/Database.php')) {
    echo "❌ ERROR: Database.php not found at: " . SRC_PATH . "/Database.php\n";
    exit(1);
}
