<?php
/**
 * View: Cadastro de Novo Serviço
 * Controller: ServicoController
 * 
 * Formulário completo para cadastrar novo serviço com:
 * - Dados principais
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            ...
                            <textarea class="form-control" 
                                      ...
                                      name="descricao" 
                                      rows="4"
                                      placeholder="Descreva as atividades e responsabilidades deste serviço..."></textarea>
