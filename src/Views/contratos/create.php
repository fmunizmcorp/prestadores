<?php
/**
 * View: Cadastro de Novo Contrato
...
<div class="container-fluid py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="h2 mb-1">Cadastrar Novo Contrato</h1>
            <p class="text-muted mb-0">Preencha os dados do contrato</p>
        </div>
    ...
    <div class="card shadow-sm">
        <div class="card-body">
            <form method="POST" action="?page=contratos&action=store" id="formContrato" enctype="multipart/form-data" novalidate>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            ...
                            <textarea class="form-control" 
                                      ...
                                      rows="3"
                                      required
                                      placeholder="Descreva resumidamente o objeto do contrato..."></textarea>
