<?php
$pageTitle = 'Nova Empresa Tomadora';
...
<div class="row mb-4">
    <div class="col-md-12">
        <h2><i class="fas fa-plus-circle"></i> Nova Empresa Tomadora</h2>
        <p class="text-muted">Cadastrar nova empresa cliente (tomadora de serviço)</p>
    </div>
</div>

<form method="POST" action="?page=empresas-tomadoras&action=store" enctype="multipart/form-data" class="needs-validation" novalidate>
