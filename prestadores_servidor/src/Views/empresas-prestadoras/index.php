<?php
$pageTitle = 'Empresas Prestadoras';
...
<div class="row mb-4">
    <div class="col-md-8">
        <h2><i class="fas fa-briefcase"></i> Empresas Prestadoras</h2>
                ...
                <nav aria-label="Paginação">
                    <ul class="pagination justify-content-center">
                        ...
                        if ($currentPage > 1):
                            ...
                            $prevUrl = '/empresas-prestadoras?' . http_build_query($queryParams);
                        ?>
                            <li class="page-item">
                        ...
                        for ($i = $startPage; $i <= $endPage; $i++):
                            $queryParams['page'] = $i;
                            $pageUrl = '/empresas-prestadoras?' . http_build_query($queryParams);
                        ?>
                        ...
                        if ($currentPage < $totalPaginas):
                            $queryParams['page'] = $currentPage + 1;
                            $nextUrl = '/empresas-prestadoras?' . http_build_query($queryParams);
                        ?>
                            <li class="page-item">
...
$('.btn-delete').on('click', function() {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            form.attr('action', `/empresas-prestadoras/${id}/delete`);
            form.submit();
        }
    });
});
